...
// ====== Mixitup ========== //
let mixerCertificate = mixitup('.certificate__container', {
  selectors: {
      target: '.certificate__card'
  },
  animation: {
      duration: 300
  }
...
// ====== Mixitup Active Link ========== //
const linkCertificate = document.querySelectorAll('.certificate__item')
function activeCertificate(){
  linkCertificate.forEach(L=> L.classList.remove('active-certificate'))
  this.classList.add('active-certificate')
}
